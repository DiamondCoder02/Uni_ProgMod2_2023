...
public class LoggingAspect {
    ...
    @Before("execution(* com.lesson6.UserController.*(..))")
    ...
    @AfterReturning("execution(* com.lesson6.UserController.*(..))")
    public void logAfterReturning(JoinPoint joinPoint) {
        String methodName = joinPoint.getSignature().getName();
        logInfo.info("Metódus futtatása befejeződött a(z) " + methodName + " metódus után");
    }

    @AfterThrowing(pointcut = "execution(* com.lesson6.UserController.*(..))", throwing = "ex")
